...
function App() {
  ...
  function handleLikeUpdateToy(updatedLikeToy){
    const updatedToy = toys.map(toy => toy.id === updatedLikeToy.id ? updatedLikeToy : toy)
    setToys(updatedToy)
  }
  ...
  return (
    <>
      ...
      <ToyContainer 
        ...
        onLikeUpdateToy={handleLikeUpdateToy}
      />
    </>
  );
}
